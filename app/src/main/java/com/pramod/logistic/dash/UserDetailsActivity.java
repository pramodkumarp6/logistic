package com.pramod.logistic.dash;
...
import com.pramod.logistic.databinding.ActivityUserDetailsBinding;
...
public class UserDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarUserDetails.fab.setOnClickListener(new View.OnClickListener() {
            @Override
